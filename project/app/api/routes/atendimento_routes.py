...
# @router.post("/cadastrar-historico-cancer-pele")
# async def cadastrar_historico_cancer_pele(
#     historico_cancer_data: HistoricoCancerPeleCreateSchema,
#     atendimento_id: int,
#     db: AsyncSession = Depends(get_db),
#     current_user: models.User = Depends(require_role(RoleEnum.PESQUISADOR))
# ):
...
#         raise HTTPException(status_code=400, detail="Atendimento já possui um histórico de câncer de pele")

#     new_historico = models.HistoricoCancerPele(
#         historico_familiar=historico_cancer_data.historico_familiar,
#         grau_parentesco=historico_cancer_data.grau_parentesco,
#         tipo_cancer_familiar=historico_cancer_data.tipo_cancer_familiar,
#         tipo_cancer_familiar_outro=historico_cancer_data.tipo_cancer_familiar_outro,
#         diagnostico_pessoal=historico_cancer_data.diagnostico_pessoal,
#         tipo_cancer_pessoal=historico_cancer_data.tipo_cancer_pessoal,
#         tipo_cancer_pessoal_outro=historico_cancer_data.tipo_cancer_pessoal_outro,
#         lesoes_precancerigenas=historico_cancer_data.lesoes_precancerigenas,
#         tratamento_lesoes=historico_cancer_data.tratamento_lesoes,
#         tipo_tratamento=historico_cancer_data.tipo_tratamento,
#         tipo_tratamento_outro=historico_cancer_data.tipo_tratamento_outro
#     )
...
#     return {
#         "message": "Histórico de Câncer de Pele cadastrado com sucesso!",
#         "historico_cancer_pele": new_historico
#     }

# @router.post("/cadastrar-fatores-risco-protecao")
# async def cadastrar_fatores_risco_protecao(
#     fatores_risco_data: FatoresRiscoProtecaoCreateSchema,
#     atendimento_id: int,
#     db: AsyncSession = Depends(get_db),
#     current_user: models.User = Depends(require_role(RoleEnum.PESQUISADOR))
# ):
...
#         exposicao_solar_prolongada=fatores_risco_data.exposicao_solar_prolongada,
#         frequencia_exposicao_solar=fatores_risco_data.frequencia_exposicao_solar,
#         queimaduras_graves=fatores_risco_data.queimaduras_graves,
#         quantidade_queimaduras=fatores_risco_data.quantidade_queimaduras,
#         uso_protetor_solar=fatores_risco_data.uso_protetor_solar,
#         fator_protecao_solar=fatores_risco_data.fator_protecao_solar,
#         uso_chapeu_roupa_protecao=fatores_risco_data.uso_chapeu_roupa_protecao,
#         bronzeamento_artificial=fatores_risco_data.bronzeamento_artificial,
#         checkups_dermatologicos=fatores_risco_data.checkups_dermatologicos,
#         frequencia_checkups=fatores_risco_data.frequencia_checkups,
#         participacao_campanhas_prevencao=fatores_risco_data.participacao_campanhas_prevencao
#     )
...
#     return {
#         "message": "Fatores de Risco e Proteção cadastrados com sucesso!",
#         "fatores_risco_protecao": new_fatores
#     }

# @router.post("/cadastrar-investigacao-lesoes-suspeitas")
# async def cadastrar_investigacao_lesoes_suspeitas(
#     investigacao_data: InvestigacaoLesoesSuspeitasCreateSchema,
#     atendimento_id: int,
#     db: AsyncSession = Depends(get_db),
#     current_user: models.User = Depends(require_role(RoleEnum.PESQUISADOR))
# ):
...
#         mudanca_pintas_manchas=investigacao_data.mudanca_pintas_manchas,
#         sintomas_lesoes=investigacao_data.sintomas_lesoes,
#         tempo_alteracoes=investigacao_data.tempo_alteracoes,
#         caracteristicas_lesoes=investigacao_data.caracteristicas_lesoes,
#         consulta_medica=investigacao_data.consulta_medica,
#         diagnostico_lesoes=investigacao_data.diagnostico_lesoes
#     )
...
#     return {
#         "message": "Investigação de Lesões Suspeitas cadastrada com sucesso!",
#         "investigacao_lesoes_suspeitas": new_investigacao
#     }
